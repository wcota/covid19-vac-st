...
do ii = 1,15
 ...
 theta = 0d0			!theta(i) = Infection fatality rate for the age group i
	...
	theta(1) =     0.00001156d0        !0-4
	theta(2:3) =   0.00000731992d0     !5-9, 10-14
	theta(4:5) =   0.000013243321d0    !15-19, 20-24
	theta(6:7) =   0.000023960037d0    !25-29, 30-34
	theta(8:9) =   0.000043765422d0    !35-39, 40-44
	theta(10:11) = 0.000079181129d0    !45-49, 50-54
	theta(12:13) = 0.00014325582d0     !55-59,60-64
	theta(14:15) = 0.00026167119d0     !65-69, 70-74
	theta(16) =    0.00047341986d0     !75+
